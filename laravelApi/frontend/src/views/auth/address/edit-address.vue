...
onMounted( async () => {
    try {
        // fetch data kontak by ID
        const response = await Api.get(`/api/contacts/${route.params.id}/addresses/${route.params.idAddress}`, {
            headers: {
...
const updateAddress = async () => {
    try {
        await Api.put(
            `/api/contacts/${route.params.id}/addresses/${route.params.idAddress}`,
            {
